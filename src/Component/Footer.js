...
export const Footer = () => {
  return (
    ...
    <div className="bg-gray-400 h-48 pt-2 flex justify-between border-t-2 border-gray-100">
      ...
      {/* <span>
      <button className="mt-8 mx-2  p-3 rounded-xl text-white bg-black">GET IT ON<br></br>
        Google PLay
        </button>
        </span>
        <span>
        <button className="mt-8 mx-2 flex items-center justify-between px-1  py-0 w-[186px] h-[64px] rounded-xl text-white  bg-black "><FaApple size={40} />Download on the <br/>
...
<div>
    ...
    <div className="hidden md:flex bg-zinc-900 h-15  text-zinc-500 justify-center max-w-full">
      ...
      <p className="mt-[5]">Foodie Faster </p>
        ...
        alimdfaiz6@gmail.com@gmail.com
        </div>
        </div>
